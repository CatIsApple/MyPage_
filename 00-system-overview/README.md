...
<table>
  <tr>
    <td rowspan="2" width="40%" valign="top">
      <a href="./02-program-execution-flow/compilation-interpretation/">
  ...
  <tr height="1">
    <td width="60%" height="1" valign="bottom">
      <strong><a href="./02-program-execution-flow/compilation-interpretation/">Read Article (글 읽기) →</a></strong>
    </td>
  </tr>
</table>

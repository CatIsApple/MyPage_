<sub><a href="../">MyPage_</a> / 06 . Storage &amp; Databases (저장장치와 데이터베이스)</sub>
...
<table>
  <tr>
    <td width="50%" valign="top">
      <a href="./01-relational-databases/">
  ...
  <tr>
    <td width="50%" valign="top">
      <a href="./05-transactions/">
        <img src="../assets/categories/06-storage-databases.png" alt="Transactions (트랜잭션)" width="100%">
      </a>
      <br>
  ...
  <tr>
    <td width="50%" valign="top">
      <a href="./07-storage-engines-and-pages/">
  ...
  <tr>
    <td width="50%" valign="top">
      <a href="./09-query-processing-and-optimization/">
    ...
    <td width="50%" valign="top">
      <a href="./10-concurrency-control-and-mvcc/">

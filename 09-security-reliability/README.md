<sub><a href="../">MyPage_</a> / 09 . Security &amp; Reliability (보안과 안정성)</sub>
...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <strong>Security Principles &amp; Threat Modeling (보안 원칙·위협 모델)</strong><br><br>
    ...
    <td width="50%" valign="top">
      ...
      <strong>Authentication (인증)</strong><br><br>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <strong>Authorization &amp; Sessions (인가·세션)</strong><br><br>
    ...
    <td width="50%" valign="top">
      ...
      <strong>Cryptography Basics (암호 기초)</strong><br><br>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <strong>PKI &amp; TLS (공개키 기반 구조·전송 계층 보안)</strong><br><br>
    ...
    <td width="50%" valign="top">
      ...
      <strong>Web Security (웹 보안)</strong><br><br>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <strong>Input Validation &amp; Injection (입력 검증·인젝션)</strong><br><br>
    ...
    <td width="50%" valign="top">
      ...
      <strong>Memory &amp; Concurrency Security (메모리·동시성 보안)</strong><br><br>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <strong>OS Security (운영체제 보안)</strong><br><br>
    ...
    <td width="50%" valign="top">
      ...
      <strong>Network Security (네트워크 보안)</strong><br><br>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <strong>Secrets &amp; Key Management (비밀·키 관리)</strong><br><br>
    ...
    <td width="50%" valign="top">
      ...
      <strong>Supply Chain Security (공급망 보안)</strong><br><br>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <strong>Data Security &amp; Privacy (데이터 보안·개인정보)</strong><br><br>
    ...
    <td width="50%" valign="top">
      ...
      <strong>Reliability &amp; Disaster Recovery (안정성·재해 복구)</strong><br><br>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <strong>Security Incident Response (보안 사고 대응)</strong><br><br>
